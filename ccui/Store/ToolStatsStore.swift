...
struct ToolStatsSnapshot: Sendable {
    ...
    static let empty = ToolStatsSnapshot(stats: [], totalEvents: 0, sessionCount: 0, generatedAt: Date())
}
...
final class ToolStatsStore {
    ...
    private nonisolated static func computeStats(persistence: any ClaudeEventPersistence, worktreePaths: Set<String>?) -> ToolStatsSnapshot {
        ...
        return ToolStatsSnapshot(stats: stats, totalEvents: totalEvents, sessionCount: sessionCount, generatedAt: Date())
    }
}
